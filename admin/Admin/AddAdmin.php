<div id="createAdminForm" class=" hidden bg-white shadow-md rounded-lg p-6 mb-6 max-w-xl mx-auto">
  <h2 class="text-xl font-semibold mb-6 text-gray-900">Create New Admin</h2>
  <form action="storeUser.php" method="POST" class="space-y-6">
    ...
    <div>
      <label for="password" class="block mb-2 text-sm font-medium text-gray-900">Alamat</label>
