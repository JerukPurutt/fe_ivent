<!DOCTYPE html>
<html lang="en" x-data="{ darkMode: false, selectedRole: '', searchQuery: '' }" x-bind:class="{ 'dark': darkMode }" xmlns="http://www.w3.org/1999/xhtml">
<head>
  <meta charset="UTF-8" />
...
<body class="flex h-screen bg-gray-100 dark:bg-gray-900 mt-16">
  ...
  <div class="flex-1 flex flex-col">
    ...
    <main class="flex-1 p-6 bg-white ml-56 p-6">
      <!-- Dashboard Section -->
