  ...
  <div class="flex-1 flex flex-col">
    ...
    <main class="flex-1 p-6">
      ...
      <div class="flex justify-between items-center mb-6">
        ...
        <button onclick="toggleCreateForm()" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded shadow">
          + Create User
        </button>
      </div>
        ...
        <table class="min-w-full bg-white border border-gray-200 shadow rounded">
          <thead class="bg-gray-100 text-gray-600 uppercase text-sm">
            <tr>
              ...
              <th class="text-left px-6 py-3 border-b">Role id</th>
              <th class="text-left px-6 py-3 border-b">Username</th>
              <th class="text-left px-6 py-3 border-b">Password</th>
          ...
          <tbody>
            ...
            <tr class="hover:bg-gray-50 text-gray-700">
              ...
              <td class="px-6 py-4 border-b">Habi</td>
              <td class="px-6 py-4 border-b">anjaymabar</td>
